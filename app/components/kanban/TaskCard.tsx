...
export const TaskCard = memo(function TaskCard({
  ...
  return (
    ...
    >
      ...
      <span
        {...dragHandleProps}
        className="absolute left-1 top-1/2 -translate-y-1/2 cursor-grab active:cursor-grabbing p-1 rounded opacity-0 group-hover:opacity-40 hover:!opacity-70 transition-opacity"
        ...
        <div className="flex items-center justify-between pt-1 gap-2">
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            <time
              ...
              className="text-[10px] text-slate-400 dark:text-slate-500 mr-1"
            >
